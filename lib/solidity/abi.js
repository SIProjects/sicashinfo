...
const src20List = require('./src20-abi.json')
const src721List = require('./src721-abi.json')
...
const src20ABIs = transformABIList(src20List)
const src721ABIs = transformABIList(src721List)

Object.assign(exports, {MethodABI, EventABI, src20ABIs, src721ABIs})
